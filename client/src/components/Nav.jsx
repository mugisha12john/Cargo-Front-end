    ...
    <header className="py-4 mx-4 shadow-md">
        <nav className="container mx-auto flex items-center justify-between px-4 relative">
            ...
            <div className="hidden md:flex space-x-4">
                <button className="px-4 py-1 bg-skyBlue text-white rounded-xl">Login</button>
                <button className="px-4 py-1 border-2 border-skyBlue rounded-xl">Sign Up</button>
            </div>
            {isMenuOpen && (
            <div className="absolute top-full left-0 w-full bg-white shadow-md mt-2 p-4 z-10 md:hidden space-y-3 text-center">
                ...
                <div className="space-y-2 pt-4">
                    <button className="w-full px-4 py-2 bg-skyBlue text-white rounded-xl">Login</button>
                    <button className="w-full px-4 py-2 border-2 border-skyBlue rounded-xl">Sign Up</button>
                </div>
            </div>
            )}
        </nav>
